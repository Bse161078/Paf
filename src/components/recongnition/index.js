...
let message;
let signUp;
let submit,recognitionProcedure,recognitionProcedureDetails,resultsOfRecognition,resultsOfRecognitionDetails,nonEUCitizens,nonEUCitizensDetails,costOfRecognition,costOfRecognitionDetails,timlineOfRecognition,timlineOfRecognitionDetails;
    ...
    const { selectedLanguage } = useSelector((state) => state.languageReducer);
        ...
        const loadConstant = async () => {
            ...
            ({
                ...
                message,
                signUp,
                submit,recognitionProcedure,recognitionProcedureDetails,resultsOfRecognition,resultsOfRecognitionDetails,nonEUCitizens,nonEUCitizensDetails,costOfRecognition,costOfRecognitionDetails,timlineOfRecognition,timlineOfRecognitionDetails
                ...
                <Grid item container xs={12} md={7} direction={"column"}>
                    <Grid item>
                        <CustomLabelHeaderLarge
                            text={recognitionProcedure}
                            color={"red"} fontWeight={"bold"}/>
                    </Grid>
                    <Grid item style={{marginTop: "20px"}}>
                        <CustomLabelLabelMedium
                            text={recognitionProcedureDetails+"\n" +
                            ""}
